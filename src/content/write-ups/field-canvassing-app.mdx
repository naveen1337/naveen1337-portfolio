...
The map layer is built on [Mapsly](https://mapsly.com), which was used to generate the organization's geographic boundaries and produce the GeoJSON that drives the application's geo-bounded logic.
